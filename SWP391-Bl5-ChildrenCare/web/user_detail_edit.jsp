...
<%-- 
    Document   : user_detail_edit
    Created on : Apr 20, 2022, 12:31:40 AM
    Author     : aDMIN
--%>
                                ...
                                <div class="card-body">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="text" class="form-control" name="fullname" value="${editUser.fullname}">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="text" class="form-control" name="email" value="${editUser.emaii}">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="text" class="form-control" name="phone" value="${editUser.phoneNumber}">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
