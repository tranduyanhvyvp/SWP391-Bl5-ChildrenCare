            ...
            <div class="content">
                ...
                <form action="ChangePasswordController" method="post">
                    ...
                    <div class="container">
                        ...
                        <input type="text" value="${sessionScope.account.username}" name="username" readonly>
                    ...
                    <input type="password" placeholder="Enter New Password" name="newPassword" id="newPassword" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" 
...
<!--                    <input type="password" placeholder="Enter New Password" name="newPassword" id="newPassword" required>-->
                    ...
                    <input type="password" placeholder="Enter Confirm New Password" name="confirmNewPassword" id="confirmNewPassword" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" 
                               title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required>
